...
bot_username = 'bathuta.app'
bot_password = 'Bathuta2022'

profiles = ['daniel_bemerguy']
amount = 30
...
class Instagram():
	def __init__(self, username, password):
		...
		self.browser = web.Chrome(executable_path=r'C:\Users\DANIEL BEMERGUY\OneDrive\BBB-analysis\chromedriver_win32\chromedriver.exe',options=options)
	...
	def login(self):
		...
		try:
			...
			# Enter username:
			username_input = browser.find_element(by='name',value='username')
	...
	def xpath_exists(self, url):
		browser = self.browser
		try:
			browser.find_element(by='XPATH',value = url)
			exist = True
	...
	def get_followers(self, users, amount):
		...
		for user in users:
			...
			time.sleep(random.randrange(3, 5))
			followers_button = browser.find_element(by='XPATH',value='/html/body/div[1]/section/main/div/header/section/ul/li[2]/div/span')
			...
			followers_ul = browser.find_element(by='XPATH',value = "/html/body/div[1]/section/main/div/header/section/ul/li[2]/a/div/span")
